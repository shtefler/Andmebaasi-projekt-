...
-- Started on 2025-05-04 23:20:39
...
--
-- TOC entry 235 (class 1255 OID 42442)
...
--
-- TOC entry 236 (class 1255 OID 42443)
...
CREATE PROCEDURE public.sp_lisa_kylastus(IN k_klient_id integer, IN k_sisenemise_aeg timestamp without time zone, IN k_klubi_id integer, IN k_valjumise_aeg timestamp without time zone)
    ...
    AS $$ 
BEGIN 
   IF k_valjumise_aeg < k_sisenemise_aeg THEN 
   RAISE EXCEPTION 'Väljumise aeg peab olema hiljem kui sisenemise aeg!'; 
   END IF; 
...
--
-- TOC entry 218 (class 1259 OID 42328)
...
--
-- TOC entry 217 (class 1259 OID 42327)
...
--
-- TOC entry 222 (class 1259 OID 42348)
...
--
-- TOC entry 221 (class 1259 OID 42347)
...
--
-- TOC entry 226 (class 1259 OID 42364)
...
--
-- TOC entry 225 (class 1259 OID 42363)
...
--
-- TOC entry 230 (class 1259 OID 42378)
...
--
-- TOC entry 229 (class 1259 OID 42377)
...
--
-- TOC entry 224 (class 1259 OID 42357)
...
CREATE TABLE public.tellimused (
    ...
    kas_tasutud bit(1) NOT NULL
);


--
-- TOC entry 223 (class 1259 OID 42356)
...
--
-- TOC entry 220 (class 1259 OID 42339)
...
--
-- TOC entry 219 (class 1259 OID 42338)
...
--
-- TOC entry 234 (class 1259 OID 42437)
...
--
-- TOC entry 233 (class 1259 OID 42433)
...
--
-- TOC entry 232 (class 1259 OID 42428)
...
--
-- TOC entry 228 (class 1259 OID 42371)
...
--
-- TOC entry 4743 (class 2604 OID 42331)
...
--
-- TOC entry 4745 (class 2604 OID 42351)
...
--
-- TOC entry 4747 (class 2604 OID 42367)
...
--
-- TOC entry 4749 (class 2604 OID 42381)
...
--
-- TOC entry 4746 (class 2604 OID 42360)
...
--
-- TOC entry 4744 (class 2604 OID 42342)
...
--
-- TOC entry 4748 (class 2604 OID 42374)
...
--
-- TOC entry 4930 (class 0 OID 42328)
-- Dependencies: 218
...
--
-- TOC entry 4934 (class 0 OID 42348)
-- Dependencies: 222
...
--
-- TOC entry 4938 (class 0 OID 42364)
-- Dependencies: 226
...
INSERT INTO public.kylastused VALUES (3, 7, '2024-09-01 08:12:00', 2, '2024-09-01 09:30:00');
INSERT INTO public.kylastused VALUES (4, 7, '2024-11-04 08:06:00', 1, '2024-11-04 09:23:00');
INSERT INTO public.kylastused VALUES (5, 10, '2025-01-27 16:12:00', 3, '2025-01-27 18:53:00');


--
-- TOC entry 4942 (class 0 OID 42378)
-- Dependencies: 230
...
--
-- TOC entry 4936 (class 0 OID 42357)
-- Dependencies: 224
...
--
-- TOC entry 4932 (class 0 OID 42339)
-- Dependencies: 220
...
--
-- TOC entry 4940 (class 0 OID 42371)
-- Dependencies: 228
-- Data for Name: vahendid; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.vahendid VALUES (1, 'Rinnalt surumise pink', 'pink');
INSERT INTO public.vahendid VALUES (2, 'Kükiraam', 'raam');
INSERT INTO public.vahendid VALUES (3, 'Jooksulint', 'masin');
INSERT INTO public.vahendid VALUES (4, 'Hantliriiul hantlitega', 'riiul');
INSERT INTO public.vahendid VALUES (5, 'Sõudeergomeeter', 'masin');
INSERT INTO public.vahendid VALUES (6, 'Reiesirutusmasin', 'masin');
INSERT INTO public.vahendid VALUES (7, 'Jõutõmbe platvorm', 'platvorm');
INSERT INTO public.vahendid VALUES (8, 'Võimlemisraam', 'raam');
...
--
-- TOC entry 4751 (class 2606 OID 42335)
...
--
-- TOC entry 4753 (class 2606 OID 42333)
...
--
-- TOC entry 4755 (class 2606 OID 42337)
...
--
-- TOC entry 4761 (class 2606 OID 42355)
...
--
-- TOC entry 4763 (class 2606 OID 42353)
...
--
-- TOC entry 4767 (class 2606 OID 42369)
...
--
-- TOC entry 4771 (class 2606 OID 42383)
...
--
-- TOC entry 4765 (class 2606 OID 42362)
...
--
-- TOC entry 4757 (class 2606 OID 42346)
...
--
-- TOC entry 4759 (class 2606 OID 42344)
...
--
-- TOC entry 4769 (class 2606 OID 42376)
...
--
-- TOC entry 4772 (class 2606 OID 42384)
-- Name: kliendid fk_klient_tellimus; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.kliendid
    ADD CONSTRAINT fk_klient_tellimus FOREIGN KEY (tellimus) REFERENCES public.tellimused(id) ON DELETE CASCADE;


--
-- TOC entry 4773 (class 2606 OID 42389)
-- Name: kliendid fk_klient_treener; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.kliendid
    ADD CONSTRAINT fk_klient_treener FOREIGN KEY (treener) REFERENCES public.treenerid(id) ON DELETE SET NULL;


--
-- TOC entry 4776 (class 2606 OID 42404)
...
--
-- TOC entry 4777 (class 2606 OID 42409)
...
--
-- TOC entry 4778 (class 2606 OID 42419)
-- Name: on_klubis fk_on_klubis_klubi; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.on_klubis
    ADD CONSTRAINT fk_on_klubis_klubi FOREIGN KEY (klubi) REFERENCES public.klubid(id) ON DELETE CASCADE;


--
-- TOC entry 4779 (class 2606 OID 42414)
-- Name: on_klubis fk_on_klubis_vahend; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.on_klubis
    ADD CONSTRAINT fk_on_klubis_vahend FOREIGN KEY (vahend) REFERENCES public.vahendid(id) ON DELETE CASCADE;


--
-- TOC entry 4775 (class 2606 OID 42399)
...
--
-- TOC entry 4774 (class 2606 OID 42394)
...
-- Completed on 2025-05-04 23:20:39
